...
function Card2() {
  return (
    <div className='md:my-0 lg:my-40 relative bg-contain bg-no-repeat xl:inline-grid lg:w-[75%]  '>
      <img
      ...
      <div className='lg:absolute  top-0 flex flex-col-reverse lg:flex-row lg:pt-10 lg:ml-20 text-center lg:text-left'>
        <div className='lg:flex-1 lg:space-y-5 px-5 space-y-5'>
          <h2 className='text-xl lg:text-4xl text-[#167EE0] lg:text-white font-semibold pt-3 lg:leading-tight'>
            One of MENA’s Leading Agency for{' '}
            <span className='text-black'>Influencer Marketing</span>
          </h2>
          <p className='text-base md:text-lg text-gray-600 lg:text-gray-200 tracking-wide'>
          ...
          <button className=' text-white hidden md:inline-grid btn-contact  py-4 bg-[#FEA366]   w-60  rounded-full text-2xl'>
            What WE DO
          </button>
          <button className=' text-white md:hidden  px-10 py-3 bg-[#FEA366]    rounded-full text-xl'>
            What WE DO
          </button>
        </div>
